...
REM
REM Generated by Vivado on Thu Nov 28 11:27:19 +0700 2024
...
echo "xvlog --incr --relax -prj System_wrapper_vlog.prj"
call xvlog  --incr --relax -prj System_wrapper_vlog.prj -log xvlog.log
